extract_city_gws=function(thisCityCode){
  ...
  raster_image_1 <- rast(glue::glue("data-raw/images/change_{thisCityCode}.tif"))
  raster_image_2 <- rast(glue::glue("data-raw/images/entropy9_{thisCityCode}.tif"))
